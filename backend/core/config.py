...
class Settings:
    ...
    # Optional S3-compatible storage (AWS S3, Cloudflare R2, MinIO, etc.).
    EVIDENCE_S3_BUCKET: Optional[str] = os.environ.get("EVIDENCE_S3_BUCKET")
    EVIDENCE_S3_PREFIX: str = os.environ.get("EVIDENCE_S3_PREFIX", "auditly-evidence")
